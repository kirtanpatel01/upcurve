      ...
      <div className="flex items-center space-x-3 flex-1">
        {editing ? (
          ...
          <>
            ...
            <label
              htmlFor={habit.id}
              className={`text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 cursor-pointer ${isCompleted ? "text-muted-foreground line-through" : ""
                }`}
            >
              {habit.name}
            </label>
